...
import styles from './styles/desktopProjectCard.module.css';
...
export function DesktopProjectCard({ project, workspaceColor = '#162456', onEdit, onDelete }: DesktopProjectCardProps) {
