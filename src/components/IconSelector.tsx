...
export const IconSelector: React.FC<IconSelectorProps> = ({ selectedIcon, onIconSelect, workspaceColor = '#162456' }) => {
  return (
    <div className={styles.iconSelector}>
      <h3 className={styles.title}>Escolha um ícone para o projeto</h3>
        ...
        {ICONS.map((icon) => (
          ...
          >
            <svg 
              ...
              style={{ color: selectedIcon === icon.id ? 'white' : workspaceColor }}
            >
              <path d={icon.svg} fill="currentColor" />
            </svg>
          </button>
        ))}
      </div>
