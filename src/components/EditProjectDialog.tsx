...
import styles from './styles/editProjectDialog.module.css';
...
export function EditProjectDialog({
  ...
  }, [isOpen, currentName, currentDescription, currentIcon]);
  ...
  return (
    <div className={styles.dialogOverlay}>
      <div className={styles.dialogContent}>
        <h2 className={styles.dialogTitle}>Editar Projeto</h2>
